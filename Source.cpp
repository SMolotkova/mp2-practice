...
void MCreation()
{
	...
	TMatrix<int> Matrix1 = TMatrix<int>(3);
	cout << "Enter Matrix1:" << endl;
	cin >> Matrix1;
	cout << "Matrix1 1 is:" << Matrix1 << endl;
...
int main()
{
	int n;
	do {
		cout << "Choose 1-Creating" << endl << "2-Copy_and_Deleting" << endl << "3-Equality" << endl << "4-Length" << endl << "5-Sum_Diff" << endl << "6-Multiplication" << endl << "7-Bool" << endl << "8-Index" << endl << "9-MCreation"<<endl;
		cin >> n;
		switch (n)
		{
		case 1:
